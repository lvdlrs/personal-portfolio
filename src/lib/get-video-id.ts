 ...
 * @returns {String}
 */
function stripParameters(shortcodeString: string): string {
 ...
 */
function youtube(youtubeString: string): string | undefined {
 ...
 * @returns {String|undefined}
 */
function vimeo(vimeoString: string): string | undefined {
 ...
 * @returns {string|undefined}
 */
function vine(string_: string): string | undefined {
 ...
 * @returns {string|undefined}
 */
function videopress(urlString: string): string | undefined {
  let idRegex;
 ...
 * @returns {string|undefined}
 */
function microsoftStream(urlString: string): string | undefined {
 ...
 * @returns {string|undefined}
 */
function tiktok(urlString: string): string | undefined {
 ...
 * @returns {string|undefined}
 */
function dailymotion(urlString: string): string | undefined {
  // Parse basic url and embeds
 ...
 * @returns {string|undefined}
 */
function loom(urlString: string): string | undefined {
  const regex =
 ...
 * @returns {String|undefined}
 */
function getSrc(input: string): string | undefined {
 ...
 * @returns {String}
 */
function extractGoogleRedirectionUrl(input: string): string {
  if (typeof input !== "string") {
    throw new TypeError(
...
function getVideoId(urlString: string) {
  ...
  let metadata = {
    id: undefined,
    service: undefined,
  } as { id: string | undefined; service: string | undefined };
